...
{{-- 
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin.sub_category.*') ? 'active' : '' }}"
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <a href="{{ route('google.index') }}"
                                class="menu-link {{ request()->routeIs('google.index') ? 'active' : '' }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a href="{{ route('facebook.index') }}"
                                class="menu-link {{ request()->routeIs('facebook.index') ? 'active' : '' }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
