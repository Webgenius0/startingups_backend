        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{ route('admin.business_category.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div>
                        ...
                        <div class="mt-5">
                            ...
                            <a href="{{ route('admin.business_category.index') }}" class="btn btn-danger btn-lg">Back</a>
                        </div>
                    </form>
                </div>
            </div>
